...
@goat1 = Goat.new(name: 'Henry the goat', age: 3, breed: 'Abaza', job: 'Companion', address: 'Panama City, Panama', price_per_day: 120, description: 'Henry loves on long walks on the beach and is a happy companion for all your goat walking or goat friend needs!')
@goat1.user = @user1
@goat1.save
...
@goat2 = Goat.new(name: 'Franky', age: 5, breed: 'Alpine', job: 'Model', address: 'Cuernavaca, Morelos', price_per_day: 240, description: 'Franky is a very serious model and it likes catwalks and flashes')
@goat2.user = @user1
@goat2.save
...
@goat3 = Goat.new(name: 'Scoot', age: 6, breed: 'Anglo-Nubian', job: 'Kid companion', address: 'Cholula, Puebla', price_per_day: 200, description: 'This tiny goat will be the best friend for your kids')
@goat3.user = @user2
@goat3.save
...
@goat4 = Goat.new(name: 'Mildred & Jhonny', age: 8, breed: 'Appenzell Goat', job: 'lawn trimmers', address: 'Toluca, Estado de Mexico', price_per_day: 60, description: 'This hungry twins will make your life easier')
@goat4.user = @user2
@goat4.save
